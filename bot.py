...
def start_command(message):
    ...
    bot.send_message(message.chat.id,"Время:" + str(now.strftime('%H:%M')) + "\n\nНа пары ? Неужели",  reply_markup=keyboard)
